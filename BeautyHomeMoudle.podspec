...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BeautyHomeMoudle.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/1244775319@qq.com/BeautyHomeMoudle'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '1244775319@qq.com' => '1244775319@qq.com' }
  s.source           = { :git => 'https://github.com/1244775319@qq.com/BeautyHomeMoudle.git', :tag => s.version.to_s }
